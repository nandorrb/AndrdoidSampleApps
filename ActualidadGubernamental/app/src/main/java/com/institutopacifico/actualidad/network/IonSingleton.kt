...
class IonSingleton private constructor() {
    ...
    fun makeAsynchronousCompressedRequest(context: Context, web_service: String, Body: BodyObject) {
    ...
    companion object {
        private val ourInstance = IonSingleton()
        var integer_STATUS_CODE_OK: Int = 0
         var integer_STATUS_CODE_FAIL: Int = 0
         var NO_INTERNET_CONNECTION_ERROR_MESSAGE: String = ""
         var SERVER_ERROR_MESSAGE: String = ""

        val instance: IonSingleton
            get() {

                integer_STATUS_CODE_OK = ApplicationClass.context.resources.getInteger(R.integer.integer_network_status_code_ok)
                integer_STATUS_CODE_FAIL = ApplicationClass.context.resources.getInteger(R.integer.integer_failure_message)
                NO_INTERNET_CONNECTION_ERROR_MESSAGE = ApplicationClass.context.resources.getString(R.string.message_thread_error)
                SERVER_ERROR_MESSAGE = ApplicationClass.context.resources.getString(R.string.message_server_error)
                return ourInstance
            }
    }
}
